...
(function(BingTTS) {
  ...
  class Client {
    ...
    synthesize(
      ...
      locale,
      callback,
      outputFormat = OutputFormat.Riff16khz16bit
    ) {
      return __awaiter(this, void 0, void 0, function*() {
    ...
    _getBingSpeechData(text, locale, outputFormat, speechItemIndex) {
      return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
          var resultsText = yield this._makeHttpRequest(
            "POST",
          ...
          console.error(
            "Error issuing token. Did you provide a valid Bing Speech API key?"
          );
        }
        ...
        optionalHeaders = [
          ...
          {
            name: "X-Search-AppIde",
            value: "07D3234E49CE426DAA29772419F436CA"
          },
          {
            name: "X-Search-ClientID",
            value: "1ECFAE91408841A480F00935DC390960"
          },
          { name: "Ocp-Apim-Subscription-Key", value: this._apiKey }
        ];
        var SSML = this.makeSSML(text, locale);
        try {
          var blobReponse = yield this._makeHttpRequest(
            "POST",
          ...
          console.warn(
            "Error while calling Bing Speech API. Ignoring this item: '" +
              text +
              "'"
          );
        }
        ...
        if (!this.multipleXHR && nextIndex < this._waitingQueue.length) {
          this._getBingSpeechData(
            this._waitingQueue[nextIndex].text,
            this._waitingQueue[nextIndex].locale,
            this._waitingQueue[nextIndex].outputFormat,
            this._waitingQueue[nextIndex].index
          );
        }
        if (!this._playing) {
          this._play();
